        ...
        <div class="flex flex-col gap-16 w-full h-full bg-base-200/40 z-10 px-5 py-6 md:py-8 md:px-7">
          ...
          <div class="flex flex-col gap-8 items-center justify-center">
            ...
            <div class="flex flex-row items-center gap-4">
              <NuxtLink draggable="false" target="_blank" to="https://t.me/noorani_mm" class="hover:scale-110 transmission">
              ...
              <NuxtLink draggable="false" target="_blank" to="https://github.com/noorani-mm" class="hover:scale-110 transmission">
              ...
              <NuxtLink draggable="false" target="_blank" to="mailto:matio.nora2000@gmail.com" class="hover:scale-110 transmission">
