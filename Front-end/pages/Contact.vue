<template>
  <Detail title="Contact" description="I'd love to hear from you">
    <div class="card bg-base-100 image-full">
      <figure>
        <img src="/images/network.jpeg" alt="network" />
      </figure>
      <div class="card-body">
            ...
            <div class="grid grid-flow-col gap-4">
              <a target="_blank" href="https://t.me/Pe3arAbi" class="hover:scale-110 transition-all duration-150"
                ...
                >
                  ...
                  /></svg
              ></a>
              <a target="_blank" href="https://github.com/noorani-mm" class="hover:scale-110 transition-all duration-150"
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="50"
                  height="50"
                ...
                >
                  ...
                  /></svg
              ></a>
              <a target="_blank" href="mailto:matio.nora2000@gmail.com" class="hover:scale-110 transition-all duration-150"
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="50"
                  height="50"
